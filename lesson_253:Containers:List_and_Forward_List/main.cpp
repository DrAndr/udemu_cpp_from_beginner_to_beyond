 ...
 * Lesson 253 [ Containers : List and Forward List ]
 *
 * Expected result:
        ...
        Enter the name of the next stooge: test
        Enter their age: 22
        [ Larry:18 Moe:25 Curly:17 test:22 ]
        [ Larry:18 Frank:18 Moe:25 Curly:17 test:22 ]
